...
export default function Update() {
  ...
  return (
    <>
      ...
      {/* CPU Configuration */}
      <h2 className="mt-16 lg:mt-24 text-center text-xl font-bold text-blue-900 px-4">
        Edit Architecture
      </h2>
        ...
        <div className="max-w-8xl mx-auto">
          <div className="bg-white rounded-xl p-4 space-y-4 lg:p-8 lg:shadow">
            ...
            <div>
              ...
              <textarea
                className="auto-textarea h-20 mt-2 pl-2 bg-gray-100 w-full rounded-md border border-gray-300 text-black"
                type="text"
              ...
              <div className="p-4 sm:p-6 shadow-md rounded-xl bg-white border border-gray-200">
                ...
                <div>
                  ...
                  <input
                    className="auto-textarea mt-2 pl-2 h-8 bg-gray-100 w-full rounded-md border border-gray-300 text-black"
                    type="text"
                    placeholder="Enter Symbol"
                  />

                  <button className="w-full h-8 text-white bg-blue-900 rounded-lg mt-4 text-center font-semibold">
                    ADD
                  </button>
                </div>
              </div>
